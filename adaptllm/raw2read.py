...
# def search(entry) this is OLD code pre CS change:
...
if __name__ == "__main__":
    ...
    #read_compre =list(process_map(search, raw_texts, max_workers=max_workers, chunksize=8192))  this is OLD code pre CS change
